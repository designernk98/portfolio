...
export default function Services() {
 return (
  <section
   id="services"
   className="pb-[116px] pt-[50px] px-[138px] min-h-screen bg-[radial-gradient(circle_at_85%_50%,#880096_0%,#f204ff75_35%,#000000_75%)] overflow-hidden relative">
   <div className="relative z-10">
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center pt-16 md:pt-0">
     ...
     <motion.div
      ...
      <div>
       <h2 className="text-4xl md:text-5xl font-bold mb-8 text-white">
        Our <span className="text-[#F204FF]">Services</span>
       </h2>
      </div>
      ...
      <div className="bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] rounded-3xl p-8 border border-white/10 w-[429px] h-[429px]">
       <div className="flex items-start gap-4 mb-6">
        <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-[#F204FF] to-[#AD66B1] flex items-center justify-center flex-shrink-0">
     ...
     <motion.div
      ...
      <div className="relative w-[400px] h-[400px] md:w-[500px] md:h-[500px] rounded-full overflow-hidden border-2 border-white/10">
       <Image
        src="/service.jpg"
        alt="Our Services"
        fill
