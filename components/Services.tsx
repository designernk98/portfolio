...
export default function Services() {
 return (
  <section
   id="services"
   className="pb-[116px] pt-[50px] px-4 md:px-8 lg:px-[40px] xl:px-[138px] min-h-screen bg-[radial-gradient(circle_at_85%_50%,#880096_0%,#f204ff75_25%,#000000_58%)] overflow-hidden relative">
   <div className="relative z-10">
    ...
    <div className="grid lg:grid-cols-2 gap-12 items-center pt-16 md:pt-0">
     ...
     <motion.div
      ...
      {/* Service Card */}
      <div className="bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] rounded-3xl p-8 border border-white/10 w-full max-w-[429px] h-auto min-h-[429px] hover:border-[#f204ff] hover:border-2">
